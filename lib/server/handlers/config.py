...
# async def send_conf(ws:websockets.server.WebSocketServerProtocol,key:bytes,req:Dict[str,Any],rid:str,ch:Channel)->None:
#     await sutils.success(ws,key,None,rid,BUF=params.BUF,SAMPRATE=params.SMPRATE,CHNNLS=params.CHNNLS)